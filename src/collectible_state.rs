...
impl CollectibleState {
    pub fn new() -> CollectibleState {
        CollectibleState {
            x_position: rand::gen_range(0, CONFIG.horizontal_slots),
            y_position: rand::gen_range(0, CONFIG.vertical_slots),
    ...
    pub fn set_new_character(&mut self) {
        // New location.
        self.x_position = rand::gen_range(0, CONFIG.horizontal_slots);
        self.y_position = rand::gen_range(0, CONFIG.vertical_slots);
